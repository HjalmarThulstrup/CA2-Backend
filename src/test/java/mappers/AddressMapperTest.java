...
public class AddressMapperTest {
    ...
    public void testCreateAddress() {
        ...
        AddressDTO result = addrMapper.createAddress(address);
    ...
    public void testGetAddress() {
        System.out.println("getAddress");
          ...
          assertEquals("Tester Road, test", addrMapper.getAddress(2).getStreetAndInfo());
    }
    ...
    public void testEditAddress() {
        ...
        assertEquals("Tester Edit Road, test", addrMapper.getAddress(3).getStreetAndInfo());
        address.setStreet("Edited Road");
        addrMapper.editAddress(address);
        assertEquals("Edited Road, test", addrMapper.getAddress(3).getStreetAndInfo());
    }
    ...
    public void testDeleteAddress() {
        ...
        int id = 2;
        assertEquals("Tester Road, test", addrMapper.getAddress(id).getStreetAndInfo());
